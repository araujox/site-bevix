  ...
  try {
    ...
    const settings = await prisma.storeSettings.upsert({
      ...
      update: {
        ...
        minimumValue: minimumValue !== undefined ? parseFloat(minimumValue) : undefined,
      ...
      create: {
        ...
        minimumValue: minimumValue !== undefined ? parseFloat(minimumValue) : 0.00,
        maintenanceMode: maintenanceMode !== undefined ? Boolean(maintenanceMode) : false,
        maintenanceTitle: maintenanceTitle || 'Preparando Novidades!',
        maintenanceMessage: maintenanceMessage || 'Estamos atualizando nosso catálogo com a nova coleção. Voltamos em breve com muitas novidades para você!',
